...
namespace PetGrooming.Controllers
{
    public class PetController : Controller
    {
        ...
        public ActionResult Update(int id, string PetName, string PetColor, double PetWeight, string PetNotes)
        {
            ...
            string query = "update pets set PetName=@PetName, color=@PetColor, Weight=@PetWeight, Notes=@PetNotes WHERE PetID=@Id";
            SqlParameter[] sqlparams = new SqlParameter[5];
            sqlparams[0] = new SqlParameter("@PetName", PetName);
            sqlparams[1] = new SqlParameter("@PetColor", PetColor);
